export default {
  ...
  'pages.searchTable.updateForm.name':'注文番号',
  'pages.searchTable.paidTime':'支払い時間',
  'pages.searchTable.orderTotal':'注文金額',
  'pages.searchTable.fulfillmentStatus':'配送状況',
  'pages.searchTable.unfulfilled':'配達されない',
  'pages.searchTable.fulfilled':'配信済み'
};
