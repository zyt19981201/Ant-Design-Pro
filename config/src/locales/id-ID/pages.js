export default {
  ...
  'pages.searchTable.updateForm.name':'Jumlah order',
  'pages.searchTable.paidTime':'Waktu pembayaran',
  'pages.searchTable.orderTotal':'Jumlah pesanan',
  'pages.searchTable.fulfillmentStatus':'Status pengiriman',
  'pages.searchTable.unfulfilled':'Tidak terkirim',
  'pages.searchTable.fulfilled':'Terkirim'
};
